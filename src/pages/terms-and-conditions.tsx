      ...
      <div className={classnames('container', 'text-2')}>
        <div className={styles.inner}>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application Store</strong> means the digital distribution service operated and developed by Apple Inc. (Apple App
            ...
            <li>
              <p>
                <strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked
            ...
            <li>
              <p>
                <strong>Feedback</strong> means feedback, innovations or suggestions sent by You regarding the attributes, performance or
            ...
            <li>
              <p>
                <strong>Subscriptions</strong> refer to the services or access to the Service offered on a subscription basis by the Company
                to You.
              </p>
            </li>
            <li>
          ...
          <h1 className="header-2-lg">Acknowledgment</h1>
          <p>
          ...
          <h1 className="header-2-lg">Subscriptions</h1>
          <h2 className="header-2-md">Subscription period</h2>
          <p>
            The Service or some parts of the Service are available only with a paid Subscription. You will be billed in advance on a
            recurring and periodic basis (such as daily, weekly, monthly or annually), depending on the type of Subscription plan you select
            when purchasing the Subscription.
          </p>
          <p>
            At the end of each period, Your Subscription will automatically renew under the exact same conditions unless You cancel it or
            the Company cancels it.
          </p>
          <h2 className="header-2-md">Subscription cancellations</h2>
          <p>
            You may cancel Your Subscription renewal either through Your Account settings page or by contacting the Company. You will not
            receive a refund for the fees You already paid for Your current Subscription period and You will be able to access the Service
            until the end of Your current Subscription period.
          </p>
          <h2 className="header-2-md">Billing</h2>
          <p>
          ...
          <p>
            ...
            proceed manually, within a certain deadline date, with the full payment corresponding to the billing period as indicated on the
            invoice.
          </p>
          <h2 className="header-2-md">Fee Changes</h2>
          <p>
          ...
          <h2 className="header-2-md">Refunds</h2>
          ...
          <h1 className="header-2-lg">User Accounts</h1>
          <p>
          ...
          <p>
            ...
            trademark that is subject to any rights of another person or entity other than You without appropriate authorization, or a name
            that is otherwise offensive, vulgar or obscene.
          </p>
          <h1 className="header-2-lg">Content</h1>
          <h2 className="header-2-md">Your Right to Post Content</h2>
          <p>
          ...
          <h2 className="header-2-md">Content Restrictions</h2>
          <p>
            The Company is not responsible for the content of the Service&apos;s users. You expressly understand and agree that You are
            solely responsible for the Content and for all activity that occurs under your account, whether done so by You or any third
          ...
          <ul>
            ...
            <li>
              Spam, machine – or randomly – generated, constituting unauthorized or unsolicited advertising, chain letters, any other form
          ...
          <p>
            ...
            formatting and edits and change the manner any Content. The Company can also limit or revoke the use of the Service if You post
            ...
            find offensive, indecent, incorrect or objectionable, and You agree that under no circumstances will the Company be liable in
            any way for any content, including any errors or omissions in any content, or any loss or damage of any kind incurred as a
            result of your use of any content.
          </p>
          <h2 className="header-2-md">Content Backups</h2>
          <p>
          ...
          <h1 className="header-2-lg">Copyright Policy</h1>
          <h2 className="header-2-md">Intellectual Property Infringement</h2>
          <p>
          ...
          <p>
            ...
            attention of our copyright agent via email at jason@continuum.works and include in Your notice a detailed description of the
          ...
          <h2 className="header-2-md">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h2>
          <p>
          ...
          <p>
            You can contact our copyright agent via email at jason@continuum.works Upon receipt of a notification, the Company will take
            whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.
          </p>
          <h1 className="header-2-lg">Intellectual Property</h1>
          <p>
          ...
          <h1 className="header-2-lg">Your Feedback to Us</h1>
          <p>
            You assign all rights, title and interest in any Feedback You provide the Company. If for any reason such assignment is
            ineffective, You agree to grant the Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide right and license
          ...
          <p>
            ...
            party web sites or services. You further acknowledge and agree that the Company shall not be responsible or liable, directly or
          ...
          <h1 className="header-2-lg">Termination</h1>
          <p>
          ...
          <h1 className="header-2-lg">Limitation of Liability</h1>
          <p>
            Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any
            provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You
          ...
          <p>
            ...
            which means that some of the above limitations may not apply. In these states, each party&apos;s liability will be limited to
            the greatest extent permitted by law.
          </p>
          <h1 className="header-2-lg">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
          <p>
            ...
            implied, statutory or otherwise, with respect to the Service, including all implied warranties of merchantability, fitness for a
          ...
          <p>
            ...
            reliability, or currency of any information or content provided through the Service; or (iv) that the Service, its servers, the
            content, or e-mails sent from or on behalf of the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs
          ...
          <h1 className="header-2-lg">Governing Law</h1>
          <p>
          ...
          <h1 className="header-2-lg">Disputes Resolution</h1>
          <p>
          ...
          <h1 className="header-2-lg">For European Union (EU) Users</h1>
          <p>
          ...
          <h1 className="header-2-lg">United States Federal Government End Use Provisions</h1>
          <p>
            If You are a U.S. federal government end user, our Service is a &quot;Commercial Item&quot; as that term is defined at 48 C.F.R.
            §2.101.
          </p>
          <h1 className="header-2-lg">United States Legal Compliance</h1>
          <p>
          ...
          <h1 className="header-2-lg">Severability and Waiver</h1>
          <h2 className="header-2-md">Severability</h2>
          <p>
          ...
          <h2 className="header-2-md">Waiver</h2>
          <p>
            Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not
            effect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall be the waiver
            of a breach constitute a waiver of any subsequent breach.
          </p>
          <h1 className="header-2-lg">Translation Interpretation</h1>
          <p>
          ...
          <h1 className="header-2-lg">Changes to These Terms and Conditions</h1>
          <p>
            ...
            make reasonable efforts to provide at least 30 days&apos; notice prior to any new terms taking effect. What constitutes a
