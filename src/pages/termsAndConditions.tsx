        ...
        <ul>
          <li>
            <p>
              ...
              {' '}
              means the software program provided by the Company downloaded by You on any electronic device,
              named Continuum
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              {' '}
              means feedback, innovations or suggestions sent by You regarding the attributes, performance or
          ...
          <li>
            <p>
              ...
              {' '}
              refer to the services or access to the Service offered on a subscription basis by the Company
              to You.
            </p>
          </li>
          <li>
